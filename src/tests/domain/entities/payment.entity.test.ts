...
describe('Payment Entity', () => {
  ...
  it('should create a Payment with required properties', () => {
    ...
    expect(payment.provider).toBe(baseProps.provider);
  ...
  it('should create a Payment with all optional properties', () => {
    ...
    expect(payment.provider_payment_id).toBe(props.provider_payment_id);
    expect(payment.provider_subscription_id).toBe(props.provider_subscription_id);
    expect(payment.paid_at).toEqual(props.paid_at);
    expect(payment.error_message).toBe(props.error_message);
    expect(payment.metadata).toEqual(props.metadata);
  });
  ...
  it('should allow updating mutable fields', () => {
    ...
    expect(payment.metadata).toEqual({ updated: true });
  });
  ...
  it('should handle different PaymentStatus and PaymentMethod values', () => {
    ...
    const methods: PaymentMethod[] = ['credit_card', 'pix', 'boleto', 'paypal', 'custom_method'];
